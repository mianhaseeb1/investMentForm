                    ...
                    <ul class="notification-menu">
                        ...
                        <li>
                            <a href="javascript:;" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                <img src="URL{{('img/avatar-mini.jpg')}}" alt="">{{ access()->user()->first_name }}
                                <span class=" fa fa-angle-down"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-usermenu purple pull-right">
                                <li><a href="javascript:;">  Profile</a></li>
                                <li><a href="javascript:;"> {{ trans('strings.backend.general.member_since') }} {{ access()->user()->created_at->format("m/d/Y") }}</a></li>
                                <li>
                                    <a href="javascript:;">
                                ...
                                <li> <a href="{!! route('frontend.auth.logout') !!}"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                            </ul>
                        </li>
                        <li>
