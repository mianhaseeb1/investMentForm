   ...
   <div class="wrapper">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                     {{ Form::model($user, ['route' => ['admin.access.user.update', $user], 'class' => 'form-horizontal tasi-form', 'role' => 'form', 'method' => 'PATCH']) }}
 <div class="form-group">
                {{-- First Name --}}
                    {{ Form::label('name', trans('validation.attributes.backend.access.users.firstName'), ['class' => 'col-sm-2 col-sm-2 control-label']) }}
<div class="col-sm-10">
