...
@section('content')
    {{ Form::open(['route' => 'admin.access.user.store', 'class="form-horizontal tasi-form', 'role' => 'form', 'method' => 'post']) }}
    ...
    {{ Form::label('First Name', trans('validation.attributes.backend.access.users.firstName'), ['class' =>'col-sm-2 col-sm-2 control-label']) }}
